...
// get All
describe('ControllerTest: Busca tadas as vendas no BD passando um ID', () => {
  const req = {};
  const res = {};
...
// get By Id
describe('ControllerTest: Busca uma venda no BD passando um ID', () => {
  const req = {};
  const res = {};
...
// post sale
describe('ControllerTest: Cria uma venda no BD', () => {
  const req = {};
  const res = {};
...
// delete sale
describe('ControllerTest: Deleta uma venda no BD', () => {
  const req = {};
  const res = {};
...
// put sale
describe('ControllerTest: Edita uma venda no BD', () => {
  const req = {};
  const res = {};
