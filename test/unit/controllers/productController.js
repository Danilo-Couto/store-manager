...
// get All
describe('ControllerTest: Busca todos os produtos no BD passando um ID', () => {
  const req = {};
  const res = {};
...
// get By Id
describe('ControllerTest: Busca um produto no BD passando um ID', () => {
  const req = {};
  const res = {};
...
// post product
describe('ControllerTest: Cria um produto no BD', () => {
  const req = {};
  const res = {};
...
// put product
describe('ControllerTest: Edita um produto no BD', () => {
  const req = {};
  const res = {};
...
// delete product
describe('ControllerTest: Deleta um produto no BD', () => {
  const req = {};
  const res = {};
